            ...
            [
                {
                    ...
                    onPress:()=>{
                        ...
                        setSelectedLocations([])
                        delAllFromStore()
                        Alert.alert("Info","dane usunięte")
                    }
                },
                {
                    text:"Nie",
        ...
        <View style={style.main}>  
            {!loading ?
                <View style={style.content}>
                    <View style={style.buttonView}>
                        <View style={style.buttonsSet}>
                            ...
                            <MyButton text={"Delete all locations"} style={style.button} click={delData}/>
                            <MyButton text={"Go to map"} style={style.button} click={goToMap}/>
                        </View>
                        <View style={style.buttonsSet}>
                ...
                <View style={style.contentLoading}>
                    <Text style={style.loadingText}>Getting current location...</Text>
